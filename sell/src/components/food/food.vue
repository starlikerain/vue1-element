...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    props: {
      food: {
        // this food equal [GOODS] selectedFood
        type: Object
      }
    },
    data() {
    ...
    methods: {
      needShow(type, text) {
        if(this.onlyContent && text){
          // check only [rating content] != empty
          return false;
        }
        if(this.selectType === ALL){
          // check all rating content
          return true;
        }else {
